...
const AdminTabs = ({ productos, setProductos, pedidos, setPedidos, pacientes, setPaciente, turnos, setTurnos, caja, setCaja }) => {
    ...
    const tabs = [
        ...
        { key: 'caja', label: 'Caja', component: <CajaTabs caja={caja} setCaja={setCaja}></CajaTabs> }
    ];
