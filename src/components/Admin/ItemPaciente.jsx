            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <Button variant="warning" className="mt-2 me-1" onClick={() => abrirModalEscolar(itemPaciente.idPaciente)}><i className="bi bi-backpack-fill"></i></Button>
                        <Button variant="dark" className="mt-2 ms-1" as={Link} to={`/evolucion/${itemPaciente.idPaciente}`}><i className="bi bi-arrow-clockwise"></i></Button>
                    </div>
                </td>
            </tr>
