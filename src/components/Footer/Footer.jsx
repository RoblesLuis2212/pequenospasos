        ...
        <footer className='container-fluid bg-container'>
            <div className="row">
                ...
                <div className="col-12 col-md-4 col-lg-3 d-flex flex-column align-items-center align-items-md-start order-3 order-md-4 order-lg-4">
                    {/* Columna de contacto */}
                    <h5 className="titulo-columnas mt-4 mt-md-0 mt-md-0">Contacto</h5>
                    <p className="texto"><i className="bi bi-whatsapp me-2"></i>3863418518</p>
                    <p className="texto"><i className="bi bi-envelope-fill me-2 me-md-0 me-lg-2"></i>lucianafono2014@gmail.com</p>
                    <p className="texto"><i class="bi bi-geo-alt-fill me-2 me-md-0 me-lg-2"></i>Belgrano 625, Monteros Tucumán</p>
